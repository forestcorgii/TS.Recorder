...
Namespace Controller
    Public Class Settings
        Public Shared Function GetSettings(databaseManager As utility_service.Manager.Mysql, settingsName As String) As Model.Settings
            ...
            Try
                Using reader As MySqlDataReader = databaseManager.ExecuteDataReader(String.Format("SELECT * FROM faces_schema.settings WHERE name='{0}';", settingsName))
        ...
        Public Shared Sub SaveSettings(databaseManager As utility_service.Manager.Mysql, settings As Model.Settings)
            Try
                Dim command As New MySqlCommand("REPLACE INTO faces_schema.settings(name,json_argument) VALUES(?,?);", databaseManager.Connection)
